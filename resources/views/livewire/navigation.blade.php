      ...
      <div class="relative flex items-center justify-between h-16">
        ...
        <div class="flex-1 flex items-center justify-center sm:items-stretch sm:justify-start">
         ...
         {{--Logo--}}
            ...
            <img class="block lg:hidden h-8 w-auto" src="https://www.cmsnextech.com/wp-content/uploads/2022/04/cms-nextech-logo.png" alt="CMS Nextech">
            <img class="hidden lg:block h-8 w-auto" src="https://www.cmsnextech.com/wp-content/uploads/2022/04/cms-nextech-logo.png" alt="CMS Nextech">
            </a>
          ...
          <div class="hidden sm:block sm:ml-6">
            <div class="flex space-x-4">
              ...
              <a href="{{ route('posts.index') }}" class="text-gray-300 hover:bg-gray-700 hover:text-white block px-3 py-2 rounded-md text-base font-medium">Library</a>
...
{{--PROFILE--}}
   ...
   {{--Menu Mobil--}}
    <div class="sm:hidden"  x-show="open" x-on:click.away="open = false"  id="mobile-menu_">
